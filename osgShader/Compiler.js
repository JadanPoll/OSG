...
import factory from '../osgShader/nodeFactory.js';
import utils from '../osg/utils.js';
import CompilerVertex from '../osgShader/CompilerVertex.js';
import CompilerFragment from '../osgShader/CompilerFragment.js';
...
Compiler.prototype = utils.extend({}, CompilerVertex, CompilerFragment, {
    ...
    getOrCreateVarying: function(type, nameID) {
        ...
        // if it.js's not in Varying Cache, but requested from vertex shader it means => error
