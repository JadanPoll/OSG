...
import { vec2 } from '../osg/glMatrix.js';
...
var getWebVRShader = function() {
    var fragmentshader = [
        ...
        'void main(void) {',
        '  vec2 uv = (vTexCoord0 * 2.0) - 1.0;.js', // range from [0,1] to [-1,1]
