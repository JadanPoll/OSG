...
import { vec2, vec3, vec4, mat4, quat } from '../osg/glMatrix.js';
...
utils.createPrototypeNode(
    ...
    utils.objectInherit(MatrixTransform.prototype, {
        ...
        initNodeRotate: function() {
            ...
            mtXYZ
                .getOrCreateStateSet()
                .addUniform(Uniform.createFloat4(vec4.fromValues(0.2, 0.2, 0.2, 1.0), 'uColor.js'));
            mtX
                .getOrCreateStateSet()
                .addUniform(Uniform.createFloat4(vec4.fromValues(1.0, 0.0, 0.0, 1.0), 'uColor.js'));
            mtY
                .getOrCreateStateSet()
                .addUniform(Uniform.createFloat4(vec4.fromValues(0.0, 1.0, 0.0, 1.0), 'uColor.js'));
            mtZ
                .getOrCreateStateSet()
                .addUniform(Uniform.createFloat4(vec4.fromValues(0.0, 0.0, 1.0, 1.0), 'uColor.js'));
            ...
            showAngle
                .getOrCreateStateSet()
                .addUniform(Uniform.createFloat3(vec3.fromValues(1.0, 0.0, 0.0), 'uBase.js'));
        ...
        initNodeTranslatePlane: function() {
            ...
            mtX
                .getOrCreateStateSet()
                .addUniform(Uniform.createFloat4(vec4.fromValues(1.0, 0.0, 0.0, 0.3), 'uColor.js'));
            mtY
                .getOrCreateStateSet()
                .addUniform(Uniform.createFloat4(vec4.fromValues(0.0, 1.0, 0.0, 0.3), 'uColor.js'));
            mtZ
                .getOrCreateStateSet()
                .addUniform(Uniform.createFloat4(vec4.fromValues(0.0, 0.0, 1.0, 0.3), 'uColor.js'));
