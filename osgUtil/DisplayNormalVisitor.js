...
var DisplayNormalVisitor = function() {
    ...
    ns.addUniform(Uniform.createFloat3(vec3.fromValues(1.0, 0.0, 0.0), 'uColorDebug.js'));
    ...
    ts.addUniform(Uniform.createFloat3(vec3.fromValues(0.0, 1.0, 0.0), 'uColorDebug.js'));
